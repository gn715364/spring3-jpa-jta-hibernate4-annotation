...
@EnableJpaRepositories(basePackages="com.gn.example.dao.service.impl",entityManagerFactoryRef = "entityManagerFactory2",transactionManagerRef = "springTransactionManager")
public class JpaHibernateBConfig {
	...
	public AtomikosDataSourceBean setAtomikosDataSourceBean() {
		...
		atomikosDataSourceBean.setUniqueResourceName("sDb");
	...
	public LocalContainerEntityManagerFactoryBean setLocalContainerEntityManagerFactoryBean() {
		...
		localContainerEntityManagerFactoryBean.setPersistenceUnitName("PersistenceUnit2");
